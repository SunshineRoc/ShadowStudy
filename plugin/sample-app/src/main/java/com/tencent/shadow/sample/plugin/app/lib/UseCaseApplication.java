...
import com.tencent.shadow.sample.plugin.app.lib.demo.PluginDemoActivity;
...
public class UseCaseApplication extends Application {
    ...
    private static void initCase() {
        ...
        UseCaseCategory demoCategory = new UseCaseCategory("插件Demo", new UseCase[]{
                new PluginDemoActivity.Case()
        });
        useCases.add(demoCategory);
